...
if __name__ == '__main__':
    ...
    parser.add_argument('--ref_mm_path_1', '-ref_1', default='./results/style_reconstruction/0/mu_param.npz', help='Input makeup reference param 1')
    parser.add_argument('--ref_mm_path_2', '-ref_2', default='./results/style_reconstruction/1/mu_param.npz', help='Input makeup reference param 2')
    parser.add_argument('--non_makeup_img_path', '-n', default='./results/align/aligned_img_non.png', help='Input nonmakeup image path')
    parser.add_argument('--out_dir', '-o', default='./results/style_reconstruction/interpolate_transfer', help='Output directory')
    ...
    for lerp_i in range(lerp_n):
        ...
        mm_ret = compute_style_mm(shape_layer, tex_layer, spec_layer, make_layer, tri, res['id'], res['ex'], res['tx'], lerp_mu, res['sp'], res['r'],
