...
class FLAME(nn.Module):
    ...
    Given flame_util parameters this class generates a differentiable FLAME function
    ...
    def __init__(self, config):
        ...
        with open(config.MM_PATH, 'rb') as f:
        ...
        lmk_embeddings = np.load(config.LMK_PATH, allow_pickle=True, encoding='latin1')
